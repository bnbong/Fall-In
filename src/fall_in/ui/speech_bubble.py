...
class SpeechBubble:
    ...
    def _build_bubble(self) -> pygame.Surface:
        ...
        surface = pygame.Surface(
            (bubble_width + extra, bubble_height + tail_size), pygame.SRCALPHA
        )
        ...
        for i, line in enumerate(lines):
            ...
            surface.blit(
                text_surface, (body_x + padding, body_y + padding + i * line_height)
            )
    ...
    def render(self, screen: pygame.Surface) -> None:
        ...
        if self._bubble_surface:
            ...
            if self.tail_direction == "left":
                ...
                pos = (
                    self.x - temp_surface.get_width(),
                    self.y - temp_surface.get_height() // 2,
                )
            else:
                pos = (
                    self.x - temp_surface.get_width() // 2,
                    self.y - temp_surface.get_height(),
                )
